  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <a
        ...
        className="w-full bg-terracota text-crema py-3 rounded-full text-sm font-medium text-center hover:bg-terracota/90 transition-colors inline-flex items-center justify-center gap-2"
      >
